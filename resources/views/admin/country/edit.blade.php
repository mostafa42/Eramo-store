              ...
              {{-- title_ar --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input dir="rtl" required type="text" name="title_ar" class="form-control @error('title_ar') is-invalid @enderror" value="{{ $country->title_ar }}">
                    </div>
              ...
              {{-- title_en --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="title_en" class="form-control @error('title_en') is-invalid @enderror" value="{{$country->title_en}}">
                    </div>
              ...
              {{-- shortcut --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="shortcut" class="form-control @error('shortcut') is-invalid @enderror" value="{{  $country->shortcut }}">
                    </div>
               ...
               {{-- code --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="number" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ $country->code }}">
                    </div>
