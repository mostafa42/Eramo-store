...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        ...
        <h2 class="h4">Create New Country</h2>
              ...
              {{-- shortcut --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="shortcut" class="form-control @error('shortcut') is-invalid @enderror" value="{{ old('shortcut') }}">
                    </div>
               ...
               {{-- code --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="number" name="code" class="form-control @error('code') is-invalid @enderror" value="{{ old('code') }}">
                    </div>
