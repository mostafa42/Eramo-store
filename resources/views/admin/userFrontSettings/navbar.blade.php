        ...
        <table class="table table-hover table-centered table-striped table-bordered text-center ">
            <thead>
                <tr>
                    ...
                    <th class="border-gray-200">Call Us</th>
            ...
            <tbody>
                ...
                @foreach ($navbar as $navbar)
                    <tr>
                        ...
                        <td>
                            <img src=" {{ asset( $navbar->logo ) }} " width="100px">
                        </td>

                        <td>
                            <p class="text-nowrap"> {{ $navbar->call_us }} </p>
                        </td>
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details">
                                        <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-{{ $navbar->id }}" class=""><span
                        ...
                        <div class="modal fade" id="modal-{{ $navbar->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('admin.user-front-settings.edit_bar', $navbar->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="wrapper m-auto">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <img id="preview-image" src="{{ $navbar->logo }}"
                                                            alt="preview image" width="100px">
                                                    </div>
                                                    <input type="file" name="image" placeholder="Choose image" id="image" accept="image/x-png,image/jpeg"><br>
                                                    <label> Call Us </label>
                                                    <input type="text" name="call_us"
                                                        value="{{ $navbar->call_us }}" class="form-control"><br>
                                                </ul>
                                            </div>
