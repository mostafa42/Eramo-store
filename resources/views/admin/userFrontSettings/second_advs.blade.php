        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class=" d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> Second Advs</li>
                </ol>
            </nav>
            <h2 class="h4"> Second Advs </h2>
    ...
    <div class="card card-body border-0 shadow table-wrapper table-responsive">
        <table class="table table-hover table-centered table-striped table-bordered text-center ">
            ...
            <tbody>
                ...
                @foreach ($second_advs as $second_advs)
                    <tr>



                        <td>
                            <img src=" {{ asset($second_advs->image) }} " width="100px">
                        </td>

                        <td>
                            <a href="{{ $second_advs->link }}" class="btn btn-primary" target="_blank">Go</a>
                        </td>
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                        <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-edit-{{ $second_advs->id }}" class=""><span
                        ...
                        <div class="modal fade" id="modal-edit-{{ $second_advs->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form
                                        action="{{ route('admin.user-front-settings.edit_second_advs', $second_advs->id) }}"
                                            ...
                                            <div class="wrapper m-auto">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <img id="preview-image2" src="{{ $second_advs->main_image }}"
                                                    ...
                                                    <label> Link </label>
                                                    <input type="text" name="link" value="{{ $second_advs->link }}"
