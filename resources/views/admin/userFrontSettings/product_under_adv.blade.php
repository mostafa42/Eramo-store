        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class=" d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> Product Under Advs</li>
                </ol>
            </nav>
            <h2 class="h4"> Product Under Advs </h2>
            ...
            <tbody>
                ...
                @foreach ($under_adv as $under_adv)
                    <tr>
                        ...
                        <td>
                            <img src=" {{ asset($under_adv->image) }} " width="100px">
                        </td>


                        <td>
                            <a href="{{ $under_adv->link }}" class="btn btn-primary" target="_blank">Go</a>
                        </td>
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                        <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-edit-{{ $under_adv->id }}" class=""><span
                        ...
                        <div class="modal fade" id="modal-edit-{{ $under_adv->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <form
                                        action="{{ route('admin.user-front-settings.edit_under_adv_product_details', $under_adv->id) }}"
                                            ...
                                            <div class="wrapper m-auto">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <div class="col-md-12 mb-2">
                                                        <img id="preview-image2" src="{{ $under_adv->image }}"
                                                            width="100px">
                                                    </div>
                                                    <input type="file" name="image" placeholder="Choose image"
                                                        id="image2" accept="image/x-png,image/jpeg"><br>
                                                    <label> Link </label>
                                                    <input type="text" name="link" value="{{ $under_adv->link }}"
