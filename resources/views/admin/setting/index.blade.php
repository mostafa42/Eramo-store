                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <textarea name="map_iframe" class="form-control @error('map_iframe') is-invalid @enderror" id="map_iframe"
                                cols="30" rows="2">{{ $settings->map_iframe }}</textarea>
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4 d-flex justify-content-center">
                            ...
                            <input accept="image/*" type="file" name="logo"
                                data-default-file="{{ $settings->logo_url }}" data-max-file-size="10M"
                                class="dropify @error('logo') is-invalid @enderror" value="{{ old('logo') }}">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-4 d-flex justify-content-center">
                            ...
                            <input accept="image/*" type="file" name="logo_light"
                                ...
                                class="dropify @error('logo_light') is-invalid @enderror"
                                value="{{ old('logo_light') }}">
                        </div>
