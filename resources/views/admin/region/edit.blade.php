              ...
              {{-- title_ar --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input dir="rtl" required type="text" name="title_ar" class="form-control @error('title_ar') is-invalid @enderror" value="{{ $region->title_ar }}">
                    </div>
              ...
              {{-- title_en --}}
                <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="title_en" class="form-control @error('title_en') is-invalid @enderror" value="{{$region->title_en}}">
                    </div>
                   ...
                   <div class="col-md-6">
                    <div class="form-group mb-4">
                        ...
                        <select required name="city_id" id="city_id" class="form-select @error('city_id') is-invalid @enderror">
                            ...
                            <option value="{{ $city->id }}" {{ $region->city_id == $city->id ?'selected':''}}>{{  $city->title_en }}</option>
                            @endforeach
                        </select>
                    </div>
