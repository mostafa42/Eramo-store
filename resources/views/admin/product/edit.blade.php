    ...
    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" name="sku_number"
                                class="form-control @error('sku_number') is-invalid @enderror"
                ...
                {{-- sku_number --}}
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <select required name="main_category_id" id="main_category_id"
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input required type="date" name="to"
                                class="form-control @error('to') is-invalid @enderror" value="{{ $product->to }}">
                        </div>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <span class="text-danger">Prefer {{ config('imageDimensions.products.width') . '*' . config('imageDimensions.products.height') }}
                    Pixels</span>
