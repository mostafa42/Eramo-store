...
@section('content')
    ...
    <div class="card card-body border-0 shadow table-wrapper table-responsive">
        <table class="table table-hover table-centered table-striped table-bordered text-center ">
            <thead>
                <tr>
                    <th class="border-gray-200">Video Link</th>
            ...
            <tbody>
                ...
                @foreach ($about_us as $about_us)
                    <tr>
                        ...
                        <td>
                            <a href="{{ $about_us->video_link }}" style="display: inline-flex;" class=" btn btn-primary" target="_blank">  Go </p>
                        </td>

                        <td>
                            <p class="text-nowrap"> {{ substr($about_us->about_us_ar, 0, 30) }} .....</p>
                        </td>

                        <td>
                            <p class="text-nowrap"> {{ substr($about_us->about_us_en, 0, 30) }} ....</p>
                        </td>
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details">
                                        <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-{{ $about_us->id }}" class=""><span
                                ...
                                <div class="">
                                    @if (Auth::guard('admin')->user()->hasPermission('taxes-update'))
                                        <a class="btn btn-info m-1" class="dropdown-item"
                                            href="{{ route('admin.about-us.edit', $about_us->id) }}"
                        ...
                        <div class="modal fade" id="modal-{{ $about_us->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="modal-default" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h2 class="h6 modal-title">About Us</h2>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="wrapper m-auto">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                <li class="list-group-item">Vido Link : {{ $about_us->video_link }}
                                                </li>
                                                <li class="list-group-item">Title In Arabic : {{ $about_us->about_us_ar }}
                                                </li>
                                                <li class="list-group-item">Title In English : {{ $about_us->about_us_en }}
                                                </li>
