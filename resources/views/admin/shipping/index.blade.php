                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" id="search" value="{{ request()->search }}"
                                                name="search" class="form-control search-docs" placeholder="Search">
                                        </div>
                                    </div>
            ...
            <tbody>
                ...
                @foreach ($shippings as $shipping)
                    <tr>
                        ...
                        <td>
                            <p class="text-nowrap">{{ $shipping->id }}.</p>
                        </td>
                        <td>

                            @if ($shipping->city)
                                <a href="{{ route('admin.cities.index', ['city_id' => $shipping->city->id]) }}">
                                    <span class="badge bg-primary"
                                        style="font-size: 18px">{{ $shipping->city->title_en . ' - ' . $shipping->city->title_ar }}</span>
                                </a>
                            @else
                                --
                            @endif
                        ...
                        <td>
                            <span style="font-size: 18px" class="badge bg-info">{{ $shipping->cost }} EGP</span>
                        ...
                        <td>
                            @if ($shipping->created_at)
                                <span class="text-nowrap d-block h6"><i class="fas fa-calendar-week text-info"></i>
                                    {{ \Carbon\Carbon::parse($shipping->created_at)->format('d/m/Y') }} </span>
                                <span class="text-nowrap d-block h6"><i class="fas fa-clock text-success"></i>
                                    {{ \Carbon\Carbon::parse($shipping->created_at)->format('h:i:s A') }} </span>
                            @else
                                ...
                            @endif
                                ...
                                <div class="">
                                    <div data-bs-toggle="tooltip" data-bs-placement="top" title="Show Details">
                                        <button class="btn btn-primary  m-1" data-bs-toggle="modal"
                                            data-bs-target="#modal-{{ $shipping->id }}" class=""><span
                                ...
                                <div class="">
                                    @if (Auth::guard('admin')->user()->hasPermission('shippings-update'))
                                        <a class="btn btn-info m-1" class="dropdown-item"
                                            href="{{ route('admin.shippings.edit', $shipping->id) }}" title="Edit"
                                                ...
                                                <li class="list-group-item">Added By :
                                                    ...
                                                    @if ($shipping->admin)
                                                        <a class="btn btn-outline-primary"
                                                            href="{{ route('admin.admins.index', ['admin_id' => $shipping->admin->id]) }}">{{ $shipping->admin->name }}</a>
                                                    @else
                                                        --
                                                    @endif
