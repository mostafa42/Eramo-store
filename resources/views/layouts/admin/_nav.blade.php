    ...
    <ul class="navbar-nav align-items-center">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link text-dark notification-bell unread dropdown-toggle" data-unread-notifications="true" href="#" role="button" data-bs-toggle="dropdown" data-bs-display="static" aria-expanded="false">
                <svg  class="icon icon-sm text-gray-900" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-dots-fill" viewBox="0 0 16 16">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-center mt-2 py-0">
                ...
                <a href="#" class="text-center text-primary fw-bold border-bottom border-light py-3">Contacts Messages</a>
        ...
        <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <img class="avatar rounded-circle" alt="Image placeholder" src="{{ Auth::guard('admin')->user()->image_url }}">
        ...
        <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
            ...
            <a class="dropdown-item d-flex align-items-center" href="mailto:info@e-ramo.net?subject=Technical Support Email From  {{ config('app.name') }}">
