...
<html lang="en">
  <head>
    ...
    <title>Multikart | Email verification</title>
      ...
      <tbody>
            ...
            <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr class="header">
                <td align="left" valign="top">
                  <img src="{{ $settings->logo }}" class="main-logo" />
                </td>
        ...
        <tr>
          <td class="banner">
            <table>
              <tr>
                <td colspan="2"><img style="width: 100%" src="{{ $settings->verification_banner }}" alt="banner" /></td>
              </tr>
            </table>
          </td>
        </tr>
        ...
        <tr>
          <td class="section-t" style="position: relative; padding: 0 calc(15px + (88 - 15) * ((100vw - 320px) / (1920 - 320)))">
            <table style="width: 100%">
              <tr>
                <td>
                  <h1 class="heading-1" style="margin-bottom: 6px">Hi @if(Auth::check()){{ auth()->user->name }}@endif And Welcome To {{ $settings->title_en }}.!</h1>
                  <p class="pera">
                    {{$settings->description_verification_en}}
                  </p>
                </td>
              </tr>
            </table>
